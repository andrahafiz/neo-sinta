...
class UserKaryawanAccessTest extends TestCase
{
    ...
    {
        $user = User::factory()->create(['roles' => 'KARYAWAN']);
        ...
        $response->assertStatus(Response::STATUS_FORBIDDEN);
    }
